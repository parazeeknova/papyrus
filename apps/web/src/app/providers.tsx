...
import { PostHogAuthStateSync } from "@/web/features/observability/components/posthog-auth-state-sync";
import { getPostHogBrowserConfig } from "@/web/features/observability/lib/posthog-auth";
